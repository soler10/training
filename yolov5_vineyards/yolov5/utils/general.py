    ...
    if val:
        ...
        if not all(x.exists() for x in val):
            ...
            if s and autodownload:  # download script
            	...
            	print('entre dins l error però ignoració')
            	data={'train': '/home/abril/train/yolov5_vineyards/yolov5/train/images', 'val': '/home/abril/train/yolov5_vineyards/yolov5/valid/images', 'test': '/home/abril/train/yolov5_vineyards/yolov5/test/images', 'nc': 4, 'names': ['Canopy', 'Humans', 'Tractor', 'Trunks'], 'roboflow': {'workspace': 'objectdetection-1qr9x', 'project': 'vineyards_yolov5', 'version': 4, 'license': 'CC BY 4.0', 'url': 'https://universe.roboflow.com/objectdetection-1qr9x/vineyards_yolov5/dataset/4'}}
